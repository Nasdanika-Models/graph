...
public class DocumentedNamedCompositeConnectionTargetNodeProcessor<T extends DocumentedNamedCompositeConnectionTarget<?,?>> extends DocumentedNamedSubGraphNodeProcessor<T> {
