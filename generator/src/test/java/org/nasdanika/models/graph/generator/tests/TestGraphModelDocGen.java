...
import org.nasdanika.models.graph.processors.ecore.EcoreGenGraphProcessorsFactory;
 ...
 *
 */
public class TestGraphModelDocGen {
	...
	public void testGenerateGraphModelDoc() throws IOException, DiagnosticException {
		...
		EcoreGenGraphProcessorsFactory ecoreGenGraphProcessorFactory = new EcoreGenGraphProcessorsFactory(context);		
		...
		URI baseActionURI = URI.createURI("local://graph.models.nasdanika.org/");
		...
		String siteMapDomain = "https://graph.models.nasdanika.org";		
